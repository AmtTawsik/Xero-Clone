    ...
    <section class="bg-orange-100">
      <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
          ...
          <p class="mb-5 font-light  sm:text-xl text-gray-600">
            All pricing plans cover the accounting essentials, with room to
            grow.
          </p>
        </div>
        <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          {/* <!-- Pricing Card --> */}
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-black bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            <h3 class="mb-4 text-2xl font-semibold">Starter</h3>
            <p class="font-light text-gray-700 sm:text-lg dark:text-gray-400">
        ...
        <div className="flex justify-center mt-10">
          <Button className="mr-5" color="light">Try Xero for free</Button>
          <Button color="dark">See full pricing detail</Button>
        </div>
      </div>
    </section>
  );
